...
import { Button } from '@/layouts/components/plate-ui/button';
import {
  Command,
  CommandEmpty,
  CommandGroup,
  ...
  CommandItem,
  CommandList,
} from '@/layouts/components/plate-ui/command';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@/layouts/components/plate-ui/dialog';
import { Input } from '@/layouts/components/plate-ui/input';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@/layouts/components/plate-ui/popover';
